...
if "%PKG_NAME%" == "libllvm-c%PKG_VERSION:~0,1%" (
    ...
    REM https://github.com/llvm/llvm-project/blob/llvmorg-7.1.0/llvm/lib/DebugInfo/PDB/CMakeLists.txt#L12
    REM which ultimately derives from VSINSTALLDIR, see
    REM https://github.com/llvm/llvm-project/blob/llvmorg-7.1.0/llvm/cmake/config-ix.cmake#L447
    ...
    sed -i "s,!VSDIR!,$ENV{VSINSTALLDIR},g" %LIBRARY_LIB%\cmake\llvm\LLVMExports.cmake
)
