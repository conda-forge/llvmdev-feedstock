...
Once the `conda-forge` channel has been enabled, `libllvm8, lit, llvm, llvm-tools, llvmdev` can be installed with:

```
conda install libllvm8 lit llvm llvm-tools llvmdev
```
