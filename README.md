...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-libllvm7.1-green.svg)](https://anaconda.org/conda-forge/libllvm7.1) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/libllvm7.1.svg)](https://anaconda.org/conda-forge/libllvm7.1) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/libllvm7.1.svg)](https://anaconda.org/conda-forge/libllvm7.1) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/libllvm7.1.svg)](https://anaconda.org/conda-forge/libllvm7.1) |
...
| [![Conda Recipe](https://img.shields.io/badge/recipe-llvm--tools--7-green.svg)](https://anaconda.org/conda-forge/llvm-tools-7) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/llvm-tools-7.svg)](https://anaconda.org/conda-forge/llvm-tools-7) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/llvm-tools-7.svg)](https://anaconda.org/conda-forge/llvm-tools-7) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/llvm-tools-7.svg)](https://anaconda.org/conda-forge/llvm-tools-7) |
...
Once the `conda-forge` channel has been enabled, `libllvm7.1, lit, llvm, llvm-tools, llvm-tools-7, llvmdev` can be installed with `conda`:

```
conda install libllvm7.1 lit llvm llvm-tools llvm-tools-7 llvmdev
```

or with `mamba`:

```
mamba install libllvm7.1 lit llvm llvm-tools llvm-tools-7 llvmdev
```

It is possible to list all of the versions of `libllvm7.1` available on your platform with `conda`:

```
conda search libllvm7.1 --channel conda-forge
```

or with `mamba`:

```
mamba search libllvm7.1 --channel conda-forge
```
...
mamba repoquery search libllvm7.1 --channel conda-forge

# List packages depending on `libllvm7.1`:
mamba repoquery whoneeds libllvm7.1 --channel conda-forge

# List dependencies of `libllvm7.1`:
mamba repoquery depends libllvm7.1 --channel conda-forge
```
