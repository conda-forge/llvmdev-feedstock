...
Once the `conda-forge` channel has been enabled, `libllvm12, lit, llvm, llvm-tools, llvmdev` can be installed with:

```
conda install libllvm12 lit llvm llvm-tools llvmdev
```

It is possible to list all of the versions of `libllvm12` available on your platform with:
